...
def calculate_log_group_prefix(manual, date_extract):
    ...
    return f"ci-co-r-fullcarga/{cut_off_time.year}/{cut_off_time.month:02}/{cut_off_time.day:02}/{cut_off_time.hour:02}/00/"
    ...
    if 'Contents' in response:
        for obj in response['Contents']:
            ...
            # if len(filename_split) == 9:
                # if filename_split[7]== 'PDP-CASHOUT':
            result.append(obj['Key'])
                # else:
                #     print("No es cashin:" +filename_split[7])
    else:
        ...
        for line in log_data.splitlines():
            ...
            if "('REQUEST', '" in line:
                ...
                current_log = {
                    ...
                    "api_name_ewp": "",
                    "status_code_ewp": "",
                    "funcionality": "cashout",  # Se asigna el valor fijo
