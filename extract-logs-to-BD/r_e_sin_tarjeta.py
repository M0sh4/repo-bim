...
def calculate_log_group_prefix(manual, date_extract):
    ...
    return f"r-e-sin-tarjeta/{cut_off_time.year}/{cut_off_time.month:02}/{cut_off_time.day:02}/{cut_off_time.hour:02}/00/"
...
def list_files_in_s3(bucket, prefix):
    ...
    if 'Contents' in response:
        for obj in response['Contents']:
            ...
            # filename_split = obj['Key'].split('/')
            # if len(filename_split) == 9:
            #     if filename_split[7]== 'FC-EXTORNO-SIN-TARJETA':
            result.append(obj['Key'])
                # else:
                #     print("No es extorno-sin-tarjeta:" +filename_split[7])
    else:
        ...
        for line in log_data.splitlines():
            ...
            if "('REQUEST', '" in line:
                ...
                current_log = {
                    ...
                    "api_name_ewp": "",
                    "status_code_ewp": "",
                    "funcionality": "fc-sin-tarjeta",  # Se asigna el valor fijo
            ...
            # Captura de status_code_ewp
                ...
                current_log["date_capture"] = line.split()[0]  # Extraer solo la fecha
