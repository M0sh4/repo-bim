...
def calculate_log_group_prefix(manual, date_extract):
    if manual:
        ...
        return f"{COMPONENT}/{cut_off_time.year}/{cut_off_time.month:02}/{cut_off_time.day:02}/{cut_off_time.hour}/"
        ...
        for line in log_data.splitlines():
            if "('REQUEST', '" in line:
                ...
                current_log = {
                    ...
                    "api_name_ewp": "",
                    "status_code_ewp": "",
                    "funcionality": "cashin",  # Se asigna el valor fijo
