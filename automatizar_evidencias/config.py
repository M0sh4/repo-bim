ambiente = {
    ...
    "preprod": {
        ...
        "profile_name": "PDP-QA-NC-MID",
        "region":"us-east-1",
        "httpconnect": "mqfndijsjh.execute-api.us-east-1.amazonaws.com",
        "x_api":"EoMxtKHj1X9eEOFVbM9RM7CJTrDgVSdN2HCbP4Tb",
        "recurso": "/qa/b1m/pdp/b3po7/00qmv8dj45",
        "table_log": "DR5_TD_Log_20250131", #DR2_TD_Log_20241230
        "table_Values_Match": "DR5_USERS_20250131",
        "table_Values_Transaccion": "DR5_Transaccion",
        "table_Error":"Error_log",
...
LOGIN_AUTH = {
    "type_auth": {
        ...
        "agente":{
            ...
            "COMPWFULLCARGA":{  
                "usuario": "COMPWFULLCARGA",  #COMPWFULLCARGA
                "password": "pny7mx/qpn*qKyJk6#Ew",  #Dev@UAT#250112 pny7mx/qpn*qKyJk6#Ew
                "workspace": "BUSINESS",
                "identifier_type": "LOGINID",
                "authentication_type": "PASSWORD",
                "msisdn": "51969752322"  #51969752322
            },
            "COMPWGOPAY":{  
...
query_flujos = {
    ...
    "getaccountholderinfo_activate" : '''
                    ...
                    AND l.status_code_comviva <> '200'
                    and l.flg_status_registry = ""
                    and l.id in (SELECT d.id_msisdn FROM DR3_msisdn_20241230 d)
                    ORDER BY l.date_capture_datetime asc
                    LIMIT {limite};
                    |
                    SELECT 
                    ...
                    l.contexto
                    FROM {tabledata} l
                    INNER JOIN DR3_msisdn_20241230 d ON d.id_msisdn = l.id
                    WHERE 
                    l.api_name_ewp in ("getaccountholderinfo")
                    AND l.status_code_ewp = '200' {filtro_idlog}
                    AND l.status_code_comviva <> '200'
